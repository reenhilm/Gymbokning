...
namespace Gymbokning.Data.Migrations
{
    ...
    [Migration("20220819071735_AddedIdentityDbContextTypes")]
    partial class AddedIdentityDbContextTypes
    {
            ...
            modelBuilder.Entity("Gymbokning.Models.GymClass", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "GymClassName",
                            StartTime = new DateTime(2022, 8, 19, 10, 17, 35, 278, DateTimeKind.Local).AddTicks(8825)
                        });
                });
