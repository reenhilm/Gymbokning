...
namespace Gymbokning.Data.Migrations
{
    ...
    [Migration("20220819135420_NoIdOnJunctionTable")]
    partial class NoIdOnJunctionTable
    {
            ...
            modelBuilder.Entity("Gymbokning.Models.GymClass", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "GymClassName",
                            StartTime = new DateTime(2022, 8, 19, 16, 54, 20, 144, DateTimeKind.Local).AddTicks(124)
                        });
                });
